...
const charactersData = {
  ...
  frostine: {
    ...
    title: '战士',
    intro: '狐人族 女 247岁\n所属势力：商会\n来自青玄州某个狐族，父母是普通商人。茯倾自幼便对狐族所擅长的幻术一窍不通，反而对香味非常敏感，时长独自钻研香叶之类的东西，让父母很是头疼。不过茯倾凭借天赋成为远近闻名的调香师，在利普赫顿东方的港口开设了自己的调香铺。来到利普赫顿开店后与当时年幼的星小猫相识，二人成为无话不谈的好朋友。别揪我发财树的叶子啊！\n日进斗金～谢谢惠顾',
  ...
  gk: {
    ...
    introImage: '/assets/images/characters/gk-intro.jpg',
  ...
  lun: {
    ...
    title: '战士',
    intro: '人类 男 未知\n所属势力：暂无\n某个被封印的强大魔兽逸散出的魔力幻化成的人形，游离在社会活动之外，行事毫无逻辑。日渐增多的可被观察的活动记录表明轮的魔力逐渐充盈且按耐不住其混沌的本性，这意味着封印已经没有那么牢靠了。\万物归于混沌"。',
    introImage: '/assets/images/characters/gk-intro.jpg',
...
const charactersByGuild = {
  adventurerGuild: ['lumina', 'xiaosi', 'muyant', 'rachel', 'alex'],
  crystalSchool: ['xiaosi'],
  judgmentCourt: [],
  lightGuard: [],
  darkRaven: []
};
